...
#
# Original: Gunnar Wolf
# Modificación: Luis E. Ochoa Ríos
# 
...
def productor():
    ...
    while True:
        ...
        # En el código anterior el incremento de en_buffer 
        # estaba fuera del else creo que esto corrige el que haya búfers de más.. 
        # Permitiendo la igualdad.. y no teniendo que recurrir al >=
        # Felices códigos =), si lo pueden ejecutar en otra máquina estaría genial.
        # Así compruebo que la solución es correcta...
        else:
            mutex2.release()
